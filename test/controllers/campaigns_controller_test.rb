...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference('Campaign.count') do
      post campaigns_url, params: { campaign: { content: @campaign.content, goal: @campaign.goal, title: @campaign.title } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { content: @campaign.content, goal: @campaign.goal, title: @campaign.title } }
